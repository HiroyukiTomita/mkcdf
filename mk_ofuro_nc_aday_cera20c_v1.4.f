c mk_ofuro_nc_aday_cera20c_v1.4.f 
c
c This is a sample program to create netCDF file 
c for CERA20C 1DEG grid variable for a year
c
c PARAMETERS
...
C     We recommend that each variable carry a "units" attribute.
      ...
      parameter (REC_UNITS = 'days since YYYY1-MM1-DD1')
