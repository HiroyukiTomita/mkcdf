c mk_ofuro_nc_clm_lr_v1.1.f 
c
c This is a sample program to create netCDF file 
c for J-OFURO3 CLM LR (1.0 deg.) grid variable for a year
c
c PARAMETERS
...
C     We recommend that each variable carry a "units" attribute.
      ...
      parameter (REC_UNITS = 'days since 1800-01-01')
